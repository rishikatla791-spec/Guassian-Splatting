...
# Locate laptop outputs folder
laptop_output = SERVER_DIR.parent.parent / "Laptop_Gaussian_Splatting" / "output"
if not laptop_output.exists():
    laptop_output = SERVER_DIR.parent.parent / "output"

# 1. Convert Train 30k model
train_ply = laptop_output / "pretrained_train" / "train" / "point_cloud" / "iteration_30000" / "point_cloud.ply"
if train_ply.exists():
...
truck_ply = laptop_output / "truck" / "point_cloud" / "iteration_1000" / "point_cloud.ply"
if truck_ply.exists():
