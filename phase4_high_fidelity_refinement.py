...
def run_stage(iterations: int, images_dir: str, output_dir: str):
    ...
    stage_result = {
        ...
        "fps_rendering": round(1000.0 / max(0.1, t_elapsed / max(1, iterations)), 2),
...
def main():
    ...
    # Update Web Studio visualizer
    try:
        update_web_studio()
        print("[OK] Successfully updated index.html to reflect Phase 4 assets!")
    except Exception as e:
        print(f"[Warning] Could not update Web Studio index.html: {e}")
