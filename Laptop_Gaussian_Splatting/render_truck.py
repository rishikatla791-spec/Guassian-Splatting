...
sys.path.append(os.path.join(SCRIPT_DIR, "gaussian-splatting"))
...
def render_truck():
    out_dir = os.path.join(SCRIPT_DIR, "output", "truck_rendered")
    os.makedirs(out_dir, exist_ok=True)
    
    ply_path = os.path.join(out_dir, "point_cloud_1000.ply")
    cameras_json = os.path.join(SCRIPT_DIR, "output", "truck", "cameras.json")
