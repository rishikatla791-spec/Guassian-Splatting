...
def run_viser_viewer(port=8080):
    ...
    room_ply = os.path.join(output_base, "room", "point_cloud", "iteration_3000", "point_cloud.ply")
    if not os.path.exists(room_ply):
        room_ply = os.path.join(output_base, "room", "point_cloud", "iteration_2000", "point_cloud.ply")

    models = {
        "🏠 My Custom Room (Your Capture)": room_ply,
        "🎮 Playroom Scene (3,000 steps)": os.path.join(output_base, "playroom", "point_cloud", "iteration_3000", "point_cloud.ply"),
        "🚚 Truck Scene (1,000 steps)": os.path.join(output_base, "truck", "point_cloud", "iteration_1000", "point_cloud.ply"),
        "🏆 Pretrained Ultra-HD (30,000 steps)": os.path.join(output_base, "pretrained_train", "train", "point_cloud", "iteration_30000", "point_cloud.ply")
    }
    ...
    # ==============================================================================
    cams_json_path = os.path.join(output_base, "truck", "cameras.json")
    cam_handles = []
