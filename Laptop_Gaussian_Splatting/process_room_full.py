...
DATASET_DIR = os.path.join(SCRIPT_DIR, "Room_dataset")
OUTPUT_DIR = os.path.join(SCRIPT_DIR, "output", "room")
...
train_script = os.path.join(SCRIPT_DIR, "gaussian-splatting", "train.py")
build_env = os.path.join(SCRIPT_DIR, "build_env.bat")
train_cmd = (
    f'call "{build_env}" "{PYTHON_EXE}" "{train_script}" '
...
viser_script = os.path.join(SCRIPT_DIR, "viser_viewer.py")
